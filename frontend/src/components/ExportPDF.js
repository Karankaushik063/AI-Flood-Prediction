...
export default function ExportPDF({ prediction, request, location }) {
    const generatePDF = () => {
        const doc = new jsPDF();
        // Title
        doc.setFontSize(20);
    ...
    return (_jsxs("button", { onClick: generatePDF, className: "export-pdf-btn", children: [_jsx(Download, { size: 18 }), "Export PDF Report"] }));
}
